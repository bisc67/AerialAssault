...
copy "xCL_multi_cpu.exe" "C:\Program Files\Microsoft Visual Studio\VC98\Bin\CL.exe"
copy "xCL_multi_cpu.exe" "C:\Program Files\Microsoft Visual Studio\VC98\Bin\LINK.exe"
