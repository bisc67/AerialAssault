...
# ADD CPP /nologo /W3 /GX /Zi /O2 /I "$(X)" /I "$(Tribes)" /I "$(X)\x_files" /I "$(X)\Entropy" /I "$(X)\Auxiliary\bitmap" /I "$(X)\Entropy\PS2" /I "$(Tribes)\Support" /D "WIN32" /D "NDEBUG" /D "_MBCS" /D "_LIB" /YX /FD /c
...
# ADD CPP /nologo /W3 /Gm /GX /ZI /Od /I "$(X)" /I "$(Tribes)" /I "$(X)\x_files" /I "$(X)\Entropy" /I "$(X)\Auxiliary\bitmap" /I "$(X)\Entropy\PS2" /I "$(Tribes)\Support" /D "WIN32" /D "_DEBUG" /D "_MBCS" /D "_LIB" /D "X_DEBUG" /D "X_ASSERT" /YX /FD /GZ /c
...
# ADD CPP /O2 /I "$(X)" /I "$(Tribes)" /I "$(X)\x_files" /I "$(X)\Entropy" /I "$(X)\Auxiliary\bitmap" /I "$(X)\Entropy\PS2" /I "$(Tribes)\Support" /D "TARGET_PS2_DVD" /D "VENDOR_SN" /FD
# ADD BASE RSC /l 0x409 /d "NDEBUG"
# ADD RSC /l 0x409 /d "NDEBUG"
BSC32=bscmake.exe
# ADD BASE BSC32 /nologo
...
# ADD CPP /Zi /Od /I "$(X)" /I "$(Tribes)" /I "$(X)\x_files" /I "$(X)\Entropy" /I "$(X)\Auxiliary\bitmap" /I "$(X)\Entropy\PS2" /I "$(Tribes)\Support" /D "TARGET_PS2_DVD" /D "VENDOR_SN" /D "X_DEBUG" /D "X_ASSERT" /FD
# ADD BASE RSC /l 0x409 /d "_DEBUG"
# ADD RSC /l 0x409 /d "_DEBUG"
BSC32=bscmake.exe
# ADD BASE BSC32 /nologo
...
# ADD CPP /O2 /I "$(X)" /I "$(Tribes)" /I "$(X)\x_files" /I "$(X)\Entropy" /I "$(X)\Auxiliary\bitmap" /I "$(X)\Entropy\PS2" /I "$(Tribes)\Support" /D "TARGET_PS2_CLIENT" /D "VENDOR_SN" /FD
# ADD BASE RSC /l 0x409 /d "NDEBUG"
# ADD RSC /l 0x409 /d "NDEBUG"
BSC32=bscmake.exe
# ADD BASE BSC32 /nologo
...
# ADD CPP /Zi /Od /I "$(X)" /I "$(Tribes)" /I "$(X)\x_files" /I "$(X)\Entropy" /I "$(X)\Auxiliary\bitmap" /I "$(X)\Entropy\PS2" /I "$(Tribes)\Support" /D "TARGET_PS2_CLIENT" /D "VENDOR_SN" /D "X_DEBUG" /D "X_ASSERT" /FD
# ADD BASE RSC /l 0x409 /d "_DEBUG"
# ADD RSC /l 0x409 /d "_DEBUG"
BSC32=bscmake.exe
# ADD BASE BSC32 /nologo
...
# ADD CPP /O2 /I "$(X)" /I "$(Tribes)" /I "$(X)\x_files" /I "$(X)\Entropy" /I "$(X)\Auxiliary\bitmap" /I "$(X)\Entropy\PS2" /I "$(Tribes)\Support" /D "TARGET_PS2_DEV" /D "VENDOR_SN" /FD
# ADD BASE RSC /l 0x409 /d "NDEBUG"
# ADD RSC /l 0x409 /d "NDEBUG"
BSC32=bscmake.exe
# ADD BASE BSC32 /nologo
...
# ADD CPP /Zi /Od /I "$(X)" /I "$(Tribes)" /I "$(X)\x_files" /I "$(X)\Entropy" /I "$(X)\Auxiliary\bitmap" /I "$(X)\Entropy\PS2" /I "$(Tribes)\Support" /D "TARGET_PS2_DEV" /D "VENDOR_SN" /D "X_DEBUG" /D "X_ASSERT" /FD
# ADD BASE RSC /l 0x409 /d "_DEBUG"
# ADD RSC /l 0x409 /d "_DEBUG"
BSC32=bscmake.exe
# ADD BASE BSC32 /nologo
